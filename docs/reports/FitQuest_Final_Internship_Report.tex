...
%
%  TABLES: every table uses only standard column specifiers (p{}, l, r, X) so
%  that Overleaf's visual editor can preview them. Ragged-right is applied per
%  table with \raggedright rather than through a custom \newcolumntype, which
%  the visual editor cannot interpret.
%
...
\label{tab:promised}
\raggedright
\begin{tabularx}{\textwidth}{@{}p{4.4cm} p{2.1cm} X@{}}
\toprule
...
\label{tab:modules}
\raggedright
\begin{tabularx}{\textwidth}{@{}p{3.6cm} r p{2.6cm} X@{}}
\toprule
...
\label{tab:network}
\raggedright
\begin{tabularx}{\textwidth}{@{}p{4.6cm} p{4.0cm} X@{}}
\toprule
...
\raggedright
\begin{tabularx}{\textwidth}{@{}p{5.4cm} p{2.6cm} p{2.8cm} X@{}}
\toprule
...
\begin{xltabular}{\textwidth}{@{}>{\raggedright\arraybackslash}p{3.9cm} >{\raggedright\arraybackslash}p{4.6cm} >{\raggedright\arraybackslash}X@{}}
...
\raggedright
\begin{tabularx}{\textwidth}{@{}p{5.6cm} r X@{}}
\toprule
